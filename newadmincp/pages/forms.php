...
<html lang="en">
    <head>
        ...
        <title>Em dùng themes Start Bootrap AdminLTE</title>
                             ...
                             <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        ...
                                        <a href="tables.php?quanly=sanpham&ac=lietke">Sản phẩm</a>
                                    </li>
                                    <li>
                                        <a href="tables.php?quanly=loaisp&ac=lietke">Loại sản phẩm</a>
                                    </li>
                                    <li>
                                        <a href="tables.php?quanly=hieusp&ac=lietke">Hiệu sản phẩm</a>
                                    </li>
									<li>
                                        <a href="tables.php?quanly=tintuc&ac=lietke">Tin tức</a>
                                    </li>
                                    <li>
                                        <a href="tables.php?quanly=hoadon&ac=lietke">Đơn Hàng</a>
                                    </li>
									<li>
...
//				$a = new myclass;
				...
				if ($quanly == 'sanpham' && $action == 'them'){
					include("../modules/quanlysanpham/them.php");
				}elseif($quanly == 'loaisp' && $action == 'them'){
					include("../modules/quanlyloaisp/them.php");
				}elseif($quanly == 'hieusp' && $action == 'them'){
					include("../modules/quanlyhieusp/them.php");
				}elseif($quanly == 'tintuc' && $action == 'them'){
					include("../modules/quanlytintuc/them.php");
				}elseif($quanly == 'user' && $action == 'them'){
					include("../modules/quanlyuser/them.php");
					//////////////////// sua///////////
				}elseif($quanly == 'sanpham' && $action == 'sua'){
					include("../modules/quanlysanpham/sua.php");
				}elseif($quanly == 'loaisp' && $action == 'sua'){
					include("../modules/quanlyloaisp/sua.php");
				}elseif($quanly == 'hieusp' && $action == 'sua'){
					include("../modules/quanlyhieusp/sua.php");
				}elseif($quanly == 'tintuc' && $action == 'sua'){
					include("../modules/quanlytintuc/sua.php");
				}elseif($quanly == 'user' && $action == 'sua'){
